...
TEST(musaev_i_sort_double_batcher, test_pipeline_run) {
  // Create data
  std::vector<double> array = MusaevIlgarOmp::randomVector(1000000, -1000000, 1000000);
  ...
  // Create Task
  auto testRSDBompParallel = std::make_shared<MusaevIlgarOmp::RadixSortDoubleBatcherOmpParallel>(RSDBDataOmp);
